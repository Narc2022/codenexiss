...
const services = [
  {
    ...
    desc: "Comprehensive social media management solutions designed to strengthen your digital presence. We handle content creation, strategic posting, audience engagement, performance monitoring, and platform optimization, ensuring consistent brand visibility, meaningful interactions, and sustained growth across all major social media networks.",
  ...
  },
  {
    ...
    desc: "Strategic Instagram marketing focused on increasing brand visibility, audience engagement, and brand awareness through compelling content, targeted campaigns, audience interaction, optimization that drives sustainable growth and measurable results.",
    span: "",
    size: "lg",
  },
  {
    ...
    desc: "Target Facebook marketing campaigns designed to reach the right audience, increase engagement, generate quality leads, and drive conversions through strategic content, precise audience targeting, and continuous performance optimization.",
    span: "",
    size: "lg",
  },
  {
    ...
    desc: "SEO is the foundation of online visibility. Our SEO services help your website rank higher on search engines, attract targeted organic traffic, and generate quality leads without relying heavily on paid ads.",
    span: "",
    size: "lg",
  },
  {
    ...
    desc: "Professional LinkedIn marketing strategies designed to enhance B2B visibility, generate quality leads, strengthen industry authority, and expand enterprise networks.",
    span: "",
    size: "lg",
  },
  {
    ...
    title: "Google Ads",
    desc: "High-performance Google Ads campaigns designed to attract qualified traffic, generate valuable leads, and increase sales. We leverage advanced targeting, keyword optimization, and data-driven strategies to maximize ROI across the Google Search ecosystem.",
    span: "lg:col-span-2",
    size: "xl",
  ...
  },
  {
    ...
    title: "Meta Ads",
    desc: "Highly targeted Meta advertising campaigns across Facebook and Instagram designed to increase brand visibility, drive qualified traffic, boost conversions, and maximize return on ad spend through advanced audience targeting, performance optimization.",
    span: "",
    size: "lg",
  },
  {
    ...
    desc: "Content is the foundation of digital success. Our content marketing services help you attract, engage, and convert your audience through high-quality, value-driven content that builds trust and strengthens your brand presence online.",
    span: "",
    size: "lg",
  },
  {
    ...
    desc: "Email marketing is one of the most powerful and cost-effective digital marketing channels. It helps you stay connected with your audience, nurture leads, and convert subscribers into loyal customers through personalized and targeted communication.",
    span: "",
    size: "lg",
  },
  {
    ...
    title: "Copywriting",
    desc: "Great design attracts attention, but powerful copy drives action. Our copywriting services help you communicate clearly, connect emotionally, and convert visitors into customers through persuasive, high-impact writing tailored to your brand.",
    span: "",
    size: "lg",
  },
];
